...
export const AuthProvider = ({ children }) => {
  ...
  const userEmployeeId = userToken ? jwt_decode(userToken)['https://hasura.io/jwt/claims']['employeeId'] : '';
  const userName = userToken
    ? `${jwt_decode(userToken)['https://hasura.io/jwt/claims']['employeeFirstName']} ${
        jwt_decode(userToken)['https://hasura.io/jwt/claims']['employeeFirstName']
          ? `${jwt_decode(userToken)['https://hasura.io/jwt/claims']['employeeFirstName']} `
          : ''
      }${jwt_decode(userToken)['https://hasura.io/jwt/claims']['employeeLastName']}`
    : '';
